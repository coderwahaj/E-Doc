...
public class ChatActivity extends AppCompatActivity {
                                ...
                                .addOnCompleteListener(task2 -> {
                                    if (task2.isSuccessful()) {
                                        ...
                                        if (messages.isEmpty()) {
                                            ...
                                            Collections.sort(messages, (m1, m2) -> Long.compare(m1.getTimestamp(), m2.getTimestamp())); // Sort messages by timestamp
                                        }
    ...
    private void sendMessageToFirestore(String messageText) {
        ...
        Message msg = new Message(messageText, timestamp, senderName, senderEmail, senderId); // Update "receiverId" accordingly
